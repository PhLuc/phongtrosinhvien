...
const Personal = ({ dispatch }) => {
  ...
  const handleUploadFile = async (e) => {
    ...
    formData.append("upload_preset", "phongtrosinhvien")
    ...
    <section className="">
      ...
      <div className="sm:w4/5 w-3/5 mx-auto p-4 grid grid-cols-10 mt-6 gap-6">
        <form className="flex flex-col gap-3 col-span-7">
          ...
          <span
            onClick={() =>
              dispatch(modal({ isShowModal: true, modalContent: <ChangePassword phone={current?.phone} /> }))
            }
          ...
          <span
            onClick={() => dispatch(modal({ isShowModal: true, modalContent: <ChangePhone /> }))}
        ...
        <div className="col-span-3 flex flex-col gap-4">
          ...
          <img src={avatar || "/user.svg"} alt="avatar" className="w-24 h-24 object-cover border rounded-full" />
          <label
