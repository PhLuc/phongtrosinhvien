...
router.post('/register', validate(joi.object({ phone: stringReq, password, name: stringReq })), userCtrls.register)
...
router.put('/current', validate(joi.object({ name: string, avatar: string })), verifyToken, userCtrls.updateProfile)
